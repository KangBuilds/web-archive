  ...
  return (
    <Popover>
      <PopoverTrigger asChild>
        <button
          type="button"
          className="size-6 shrink-0 aspect-square rounded border border-border shadow-sm transition-shadow hover:shadow-md focus:outline-none focus:ring-2 focus:ring-ring focus:ring-offset-1"
